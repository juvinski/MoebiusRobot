#ifndef _Velocities_h
#define _Velocities_h
...
namespace riki_msgs
{
  ...
  class Velocities : public ros::Msg
  {
    ...
    virtual const char * getType(){ return "riki_msgs/Velocities"; };
    virtual const char * getMD5(){ return "0ee8ad4cb7809be2d5a0a76352fea86a"; };
